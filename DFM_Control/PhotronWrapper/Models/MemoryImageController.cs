...
namespace PhotronWrapper.Models
{
    ...
    public class MemoryImageController: IMemoryImageController
    {
    ...
    　　// Image information on play screen-------------------
        ...
        // Save image file
        public void SaveFile(string fileName, int startFrameNo, int endFrameNo)
        {
        ...
        // Save CIH file
        private void cihFileSave(string cihFileName, int startFrameNo, int endFrameNo)
        {
            UInt32 errorCode;
            UInt32 ret;
        ...
        public void MRAWFileSave(object obj, CancellationToken token)
        {
